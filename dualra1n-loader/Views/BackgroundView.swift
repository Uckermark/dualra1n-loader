...
struct BackgroundView: View {
    ...
    var body: some View {
        let themes: [[Color]] = [cyanLagune, swiftui] // TODO: add more themes & theme manager
        Rectangle()
            .irregularGradient(colors: themes[theme], background: themes[theme][0], animate: true, speed: 0.5)
            .ignoresSafeArea()
    }
}
